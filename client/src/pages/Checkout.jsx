        ...
        <div>
            <div>
                <ul className='space-y-5'>
                    <h1 className='text-xl font-bold px-2'>Checkout({cart.length})</h1>  
                    {
                        cart.length=== 0 && <div className='flex flex-col gap-5 items-center justify-center'>
                            ...
                            <p className='text-center text-xl font-bold'>No items in the Checkout!</p>
                        </div>
                    }  
                    {cart.map((c) =>(
                    ...
                    <Link to={'/checkout'} className='w-full'>
                        <button onClick={handlePayment} className='btn bg-linear-to-r from pink-500 to-red-500 w-full'>Pay Now</button>
                    </Link>
                </ul>
            </div>
        </div>
